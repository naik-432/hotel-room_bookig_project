...
if (isset($_GET['editid'])) {
	$singalData=$obj->gellsingalcategoryData($_GET['editid']);
	// var_dump($singalData);
	// die();
}
            ...
            <form action="" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="categoryname" class="form-control" placeholder="Room_Category-Name..." required="" value="<?php echo $singalData['categoryname'];?>">
                </div>
              </div>
