...
if (isset($_POST['submit'])) {
	...
	$phone=$_POST['phone'];
	$obj->SavesignupData($fullname,$email,$username,$password,$phone);
}
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/img_3.jpg);">
				...
				<form action="signup.php"  method="POST"  class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Full Name is required">
						...
						<input class="input100" type="text" name="fullname" placeholder="Enter username">
