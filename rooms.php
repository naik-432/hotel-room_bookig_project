...
{    
 ...
 $roomproduct = $obj->getAllrooms($page,$_GET['id']); 
}else{


if (isset($_GET['id'])) {
  $roomproduct=$obj->getsingaladdroomData($page,$_GET['id']);
  // echo "<pre>";
  // print_r($roomproduct);
  // echo "</pre>";
  // die();
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row">
         ...
         <?php foreach ($roomproduct['projects'] as  $data):?>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a target="_blank" href="singalpage.php?id=<?php echo $data['addroom_id'];?>" class="d-block mb-0 thumbnail"><img src="<?php echo $data['image'];?>" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#"><?php echo $data['categoryname'];?></a></h3>
                <strong class="price">Rs<?php echo $data['price'];?> / per night</strong>
              </div>
            </div>
          </div>
            <?php endforeach?>
       ...
       <?php if($roomproduct['totalPages'] > 1): ?>

        <div class="row mt-5">
          <div class="col-md-12 text-center">
            <div class="site-block-27">
              <ul>
                 <?php for($i = 1; $i <= $roomproduct['totalPages']; $i++): ?>
                <!-- <li><a href="#">&lt;</a></li> -->
              <li><a href="rooms.php?page=<?php echo $i; ?>&id=<?php echo $_GET['id'];?>"><?php echo $i; ?></a></li>
              <?php endfor; ?>
                <!-- <li><a href="#">2</a></li>
                <li><a href="#">3</a></li>
                <li><a href="#">4</a></li>
